...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("20", "10", "10", new string[0])]
        [NUnit.Framework.TestCaseAttribute("10", "20", "-10", new string[0])]
        [NUnit.Framework.TestCaseAttribute("20", "0", "20", new string[0])]
        [NUnit.Framework.TestCaseAttribute("0", "", "0", new string[0])]
        public virtual void SubstractTwoNumbers(string a, string b, string c, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Substract two numbers", exampleTags);
#line 7
